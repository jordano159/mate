...
ActiveRecord::Schema.define(version: 20_180_724_063_540) do
  ...
  create_table 'staffs', force: :cascade do |t|
    ...
    t.index %w[staffable_id staffable_type], name: 'index_staffs_on_staffable_id_and_staffable_type'
    t.index %w[staffable_type staffable_id], name: 'index_staffs_on_staffable_type_and_staffable_id'
